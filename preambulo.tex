...
\usepackage{graphicx}
% Definimos el directorio donde se guardan las imágenes
...
% Paquetes necesarios para incluir el bookmark en el pdf y generar 
% hipervínculos
\usepackage{bookmark}
\usepackage{hyperref}

% Para crear un índice de palabras
\usepackage{makeidx}
\makeindex


% Paquete que incluye una serie de comandos para la escritura de ecuaciones
% símbolos relacionados a la física 
\usepackage{physics}
\usepackage{xparse}